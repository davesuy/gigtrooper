...
class BaseFileUploadHandlerService
{
	...
	public function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		$upload_dir = storage_path("app/public/$configPrefix/$fileuploadLabel/$fileuploadId/$handle/");
		$upload_url = url("$configPrefix/$fileuploadLabel/$fileuploadId") . "/$handle/";

		$this->options = array(
			'script_url' => url('fileupload'),
