                ...
                <tr>
                    <td style="{{ $style['email-masthead'] }}">
                        <a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}"
                           href="http://gigtrooper.com" target="_blank">
                            <img src="https://gigtrooper.s3-ap-southeast-1.amazonaws.com/images/logo.png"
                                 alt="gigtrooper logo"/>
                        </a>
                    </td>
                </tr>
                                    ...
                                    <table style="{{ $style['body_action'] }}" align="center"
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <a href="{{ url('account/messages/'.$quoteMessage->source->id) }}"
