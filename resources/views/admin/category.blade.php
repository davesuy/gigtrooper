    ...
    <div class="categories tab-pane in active">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-8 text-right">
                <a href="/{{ $cpUrl }}/categories/create" class="button btn-medium">CREATE CATEGORY</a>
            </div>
        </div>

        {!! Form::open(array('url' => "$cpUrl/categories/deletes")) !!}
                ...
                <table>
                    <tr>
                        ...
                        <td><a class="s-title post-title"
                               href="/{!! \Config::get('app.cp') !!}/categories/{{ $category->id }}/edit">
                                {{ $category->title }}
                            </a></td>
                    </tr>
                </table>
